...
Prozedurales Gedächtnis: Erlernte Fähigkeiten, Gewohnheiten und automatisierte Abläufe.`,
    ...
    knowledgeDetails: {
      ...
      retrievalTestingDescription:
        'Führen Sie einen Abruftest durch, um zu prüfen, ob BONCFlow die beabsichtigten Inhalte für das LLM wiederherstellen kann.',
      Parse: 'Analysieren',
      dataset: 'Datensatz',
      testing: 'Abruftest',
      files: 'Dateien',
...
<p>Siehe https://ragflow.io/docs/dev/use_tag_sets für Details.</p>
    ...
    chat: {
      ...
      betaError:
        'Bitte erwerben Sie zuerst einen BONCFlow-API-Schlüssel auf der Systemeinstellungsseite.',
      searching: 'Suche...',
      parsing: 'Analysiere',
      uploading: 'Hochladen',
